  ...
  <header class="site-header">
    <div class="container header-inner">
      <a class="brand" href="/" aria-label="Van der Volpi – home">
      ...
      <nav class="site-nav" aria-label="Main">
        ...
        <a href="/training"<?= $active === 'Training' ? ' class="active"' : '' ?>>Training</a>
        <a href="/advice"<?= $active === 'Advice' ? ' class="active"' : '' ?>>Advice</a>
        <a href="/about"<?= $active === 'About' ? ' class="active"' : '' ?>>About</a>
        <a href="/contact" class="nav-cta<?= $active === 'Contact' ? ' active' : '' ?>">Contact</a>
      </nav>
    </div>
  </header>
