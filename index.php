    ...
    <section class="hero">
      ...
      <div class="hero-ticker" aria-hidden="true">
        <div class="hero-ticker-track">
          <span>Who owns the photo your creator just posted?</span>
          <span>Is "in collaboration with" enough disclosure?</span>
          <span>Can you use that trending sound in a brand video?</span>
          <span>What does the exclusivity clause actually cover?</span>
          <span>Can an ex-employee keep the account they grew for you?</span>
          <span>Do you need a release for a street interview?</span>
          <span>Who owns the photo your creator just posted?</span>
          <span>Is "in collaboration with" enough disclosure?</span>
          <span>Can you use that trending sound in a brand video?</span>
          <span>What does the exclusivity clause actually cover?</span>
    ...
    <section>
      <div class="container">
        <div class="section-head reveal">
          ...
          <p>Three ways in: pick the one that fits where you are today.</p>
        </div>
        <div class="card-grid reveal">
          <article class="card">
            <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
              <rect x="3" y="4" width="18" height="12" rx="2"/><path d="M7 8h7M7 12h5"/><path d="M12 16v3"/><path d="M8 21h8"/>
            </svg>
            <h3>Training</h3>
    ...
    <section class="section-periwinkle">
      <div class="container split reverse reveal">
        <figure class="split-media">
          ...
          <figcaption>Speaking on "The impact of social media on IP rights" at the European Union Intellectual Property Office (EUIPO).</figcaption>
        </figure>
        <div>
